...
`;
export const securityCourseSteps = [
    {
        order: 0,
        title: 'Introduction à la sécurité Spring Boot',
        subtitle: 'Comprendre les enjeux de la sécurité dans une application web',
        content: `${securityStepContent0}`
    },
    {
        order: 1,
        title: 'Configurer Spring Security',
        subtitle: 'Mettre en place la configuration de base avec SecurityFilterChain',
